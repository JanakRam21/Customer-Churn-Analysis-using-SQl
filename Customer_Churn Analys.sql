...
UPDATE ecommerce
SET Hourspendonapp = (SELECT AVG(Hourspendonapp) FROM ecommerce)
WHERE Hourspendonapp IS NULL 
...
UPDATE ecommerce
SET orderamounthikefromlastyear = (SELECT AVG(orderamounthikefromlastyear) FROM ecommerce)
WHERE orderamounthikefromlastyear IS NULL 

UPDATE ecommerce
SET WarehouseToHome = (SELECT  AVG(WarehouseToHome) FROM ecommerce)
WHERE WarehouseToHome IS NULL 

UPDATE ecommerce
SET couponused = (SELECT AVG(couponused) FROM ecommerce
WHERE couponused IS NULL 

UPDATE ecommerce
SET ordercount = (SELECT AVG(ordercount) FROM ecommerce)
WHERE ordercount IS NULL 

UPDATE ecommerce
SET daysincelastorder = (SELECT AVG(daysincelastorder) FROM ecommerce)
WHERE daysincelastorder IS NULL 
